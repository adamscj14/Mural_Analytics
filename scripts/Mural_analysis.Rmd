...
log_reg_present_prop_df <- data.frame(blockgroup_id = present_df$blockgroup_id, prop_score = present_df$full_log_reg)
log_reg_absent_prop_df <- data.frame(blockgroup_id = absent_df$blockgroup_id, prop_score = absent_df$full_log_reg)
sorted_present_prop_df <- log_reg_present_prop_df[order(-log_reg_present_prop_df$prop_score),]
sorted_absent_prop_df <- log_reg_absent_prop_df[order(-log_reg_absent_prop_df$prop_score),]
